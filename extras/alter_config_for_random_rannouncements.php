...
// do it
$result = $db->query('INSERT INTO '.$db->prefix.'config VALUES("o_rannouncement", "0")');
$result2 = $db->query('INSERT INTO '.$db->prefix.'config VALUES("o_rannouncement_message", "Enter your first announcement here.\nEnter your second announcement here.")');
