...
{
	if ($is_admmod)
		confirm_referrer('announcementdelete.php');
	...
	if ($is_topic_post)
	{
		...
		redirect('index.php', $lang_delete['Topic del redirect']);
	}
	else
	{
		...
		redirect('viewannouncement.php?id='.$cur_post['tid'], $lang_delete['Post del redirect']);
	}
}
...
<div class="linkst">
	<div class="inbox">
		<ul><li><a href="index.php"><?php echo $lang_common['Index'] ?></a></li><li>&nbsp;&raquo;&nbsp;<?php echo $lang_common['Announcements'] ?></li><li>&nbsp;&raquo;&nbsp;<?php echo pun_htmlspecialchars($cur_post['subject']) ?></li></ul>
	</div>
</div>
...
<div class="blockform">
	...
	<div class="box">
		<form method="post" action="announcementdelete.php?id=<?php echo $id ?>">
			<div class="inform">
				<fieldset>
