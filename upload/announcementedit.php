...
{
	if ($is_admmod)
		confirm_referrer('announcementedit.php');
	...
	if (empty($errors) && !isset($_POST['preview']))
	{
		...
		redirect('viewannouncement.php?pid='.$id.'#p'.$id, $lang_post['Edit redirect']);
	}
}
...
<div class="blockform">
	...
	<div class="box">
		<form id="edit" method="post" action="announcementedit.php?id=<?php echo $id ?>&amp;action=edit" onsubmit="return process_form(this)">
			<div class="inform">
				<fieldset>
