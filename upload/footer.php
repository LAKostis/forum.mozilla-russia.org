...
else if ($footer_style == 'viewpoll')
{
	...
	if ($is_admmod)
	{
		...
		if ($cur_topic['closed'] == '1')
			echo "\t\t\t".'<dd><a href="moderatepoll.php?fid='.$forum_id.'&amp;open='.$id.'">
'.$lang_common['Open topic'].'</a></dd>'."\n";
		else
			echo "\t\t\t".'<dd><a href="moderatepoll.php?fid='.$forum_id.'&amp;close='.$id.'"
>'.$lang_common['Close topic'].'</a></dd>'."\n";

		if ($cur_topic['sticky'] == '1')
			echo "\t\t\t".'<dd><a href="moderatepoll.php?fid='.$forum_id.'&amp;unstick='.$id.
'">'.$lang_common['Unstick topic'].'</a></dd></dl>'."\n";
		else
			echo "\t\t\t".'<dd><a href="moderatepoll.php?fid='.$forum_id.'&amp;stick='.$id.'"
>'.$lang_common['Stick topic'].'</a></dd></dl>'."\n";
	}
