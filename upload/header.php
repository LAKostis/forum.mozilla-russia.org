...
if (defined('PUN_WIKI')) {
	...
	$ID = str_replace('_',' ',$ID);
	$page_title = pun_htmlspecialchars($pun_config['o_board_title']) .' / '.$conf['title'].' / '.$ID;
?>
...
echo '<script type="text/javascript" src="uncrypt_email.js"></script>';
echo '<script type="text/javascript" src="ru-board.js"></script>';
