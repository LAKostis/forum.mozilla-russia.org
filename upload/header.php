...
?>
<script type="text/javascript" src="scripts.js?2"></script>
<link rel="stylesheet" type="text/css" href="style/<?php echo $pun_user['style'].'.css' ?>" />
<?php
}
...
if ($pun_user['is_guest'])
{
	...
	$tpl_temp = '<div id="brdwelcome" class="inbox">'."\n\t\t\t".'<ul class="conl">'."\n\t\t\t\t".'<li><form method="post" action="login.php?action=in"><input type="hidden" name="form_sent" value="1" /> <input type="hidden" name="redirect_url" value="' . $redirect_url .'" /> <input type="text" name="req_username" size="16" maxlength="25" tabindex="101" value="'. $lang_common['Username'] .'" onfocus="this.value=\'\'" /> <input type="password" name="req_password" size="12" maxlength="16" tabindex="102" value="'. $lang_common['Password'] .'" onfocus="this.value=\'\'" /> <input type="submit" name="login" value="'. $lang_common['Login'] .'" tabindex="103" /></form></li></ul>'."\n\t\t\t";
