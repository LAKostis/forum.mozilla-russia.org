...
// Language definitions used in upload.php
$lang_upload = array(

'Not allowed'				=>	'Not allowed',
'Rules Header'				=>	'Uploading Rules',
'Rule one'		=>	'You can use the upload to upload image and text with the following extention. (.txt, .gif, .jpg, .jpeg, .png, .xpi)',
'Rule two'					=>	'The file must be under',
