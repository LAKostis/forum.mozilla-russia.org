...
'Code'					=>	'Код',
'Code info'				=>	'Для отображения исходного кода чего-либо используйте тег code. Текст, отмеченный этим тегом, отображается моноширинным шрифтом и на него не действуют другие теги.',
...
'Bold, underlined text'	=>	'Жирный и подчёркнутый текст',
