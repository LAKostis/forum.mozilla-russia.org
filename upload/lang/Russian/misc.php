...
'Reason desc'				=>	'Пожалуйста, кратко опишите причину, по которой модератор должен рассмотреть ваше сообщение.',
'Report more'				=>	'Дополнительные параметры',
...
'Leave redirect'			=>	'Оставить переадресацию темы/тем в текущем форуме',
'Post redirect message'		=>	'Написать в тему/темы сообщение о переносе',
'Close topics'				=>	'Принудительно закрыть тему/темы после переноса',
'Open topics'				=>	'Принудительно открыть тему/темы после переноса',
...
'Stick post redirect'		=>	'Сообщение прикреплено. Переадресация...',
'Unstick post redirect'		=>	'Сообщение откреплено. Переадресация...',
'Unblock post redirect'		=>	'Сообщение разблокировано. Переадресация...',
