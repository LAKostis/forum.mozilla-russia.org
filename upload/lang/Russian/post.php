...
'Too long message'	=>	'Сообщение не может быть длиннее 65535 символов (64 КБ).',

// Posting
'Post errors'		=>	'Ошибки при отправке',
'Post errors info'	=>	'Перед отправкой сообщения необходимо исправить следующие ошибки:',
...
'Related topics'	=>	'Похожие темы на форуме',
'Modified'			=>	'В тему были внесены изменения, возможно вам стоит исправить ваше сообщение.',
