...
'Files'							=>	'Загруженно файлов',
'Show files'					=>	'Показать все загруженные файлы',
...
'Sig preview'					=>	'Просмотр текущей подписи:',
'No sig'						=>	'Нет подписи.',
...
'Show redirect page'			=>	'Показывать страницы переадресации.',
...
'Admin note'					=>	'Примечания администратора',
...
'Redirect page legend'			=>	'Страницы переадресации',
'Redirect page info'			=>	'Страница переадресации выводит сообщение о том, что какие-либо Ваши действия на форуме прошли успешно. Будь то отправка сообщения, измение данных в профиле и т.д...',
