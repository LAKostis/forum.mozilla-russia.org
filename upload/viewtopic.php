...
while ($cur_post = $db->fetch_assoc($result))
{
	...
	if ($cur_post['poster_id'] > 1)
	{
		...
		if (!$quickpost)
			...
			$username = '<a href="javascript:pasteN();" onmouseover="copyQ(this, true);">'.pun_htmlspecialchars($cur_post['username']).'</a>';
	...
	if (!$is_admmod)
	{
		...
		if ($cur_topic['closed'] == '0')
		{
			...
			if ($quickpost)
			$post_actions[] = '</li><li class="postquote" onmouseover="copyQ(this, false, true);"><a href="javascript:pasteQ();">'.$lang_topic['Quote'].'</a>';
		}
	}
	else
	{
		...
		$post_actions[] = '<li class="postreport"><a href="misc.php?report='.$cur_post['id'].'">'.$lang_topic['Report'].'</a>'.$lang_topic['Link separator'].'</li><li class="postdelete"><a href="delete.php?id='.$cur_post['id'].'">'.$lang_topic['Delete'].'</a>'.$lang_topic['Link separator'].'</li><li class="postedit"><a href="edit.php?id='.$cur_post['id'].'">'.$lang_topic['Edit'].'</a>'.$lang_topic['Link separator'].'</li><li class="postquote"><a href="post.php?tid='.$id.'&amp;qid='.$cur_post['id'].'">'.$lang_topic['Reply'].'</a>'.$lang_topic['Link separator'].'</li><li class="postquote" onmouseover="copyQ(this, false, true);"><a href="javascript:pasteQ();">'.$lang_topic['Quote'].'</a>';
	}
