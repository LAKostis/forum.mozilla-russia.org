...
$conf['umask']       = 0112;              //set the umask for new files
$conf['dmask']       = 0001;              //directory mask accordingly
$conf['lang']        = $pun_user['language'];              //your language
$conf['datadir']     = './wiki/data';          //where to store the data
$conf['olddir']      = './wiki/attic';         //where to store old revisions
$conf['mediadir']    = './wiki/media';         //where to store media files
$conf['mediaweb']    = 'wiki/media';           //access to media from the web
$conf['changelog']   = './wiki/changes.log';   //change log
