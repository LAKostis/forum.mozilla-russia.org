...
/* $Id: blowfish.php,v 1.1 2006/03/16 17:54:52 cvs_admin Exp $ */
 ...
 * @param  integer  $pad_length length of the result
 * @param  string  $pad_string  the filling string
 * @param  integer  $pad_type padding mode
 *
