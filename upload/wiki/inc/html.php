...
function html_revisions(){
	...
	foreach($revisions as $rev){
		...
		print '<img src="'.getBaseURL().'wiki/images/diff.png" border="0" width="15" height="11" title="'.$lang['diff'].'" />';
		print '</a>';
		print '</li>';
	}
	print '</ul>';
...
function html_diff($text='',$intro=true){
	require_once("wiki/inc/DifferenceEngine.php");
	global $ID;
	global $REV;
	global $lang;
	global $conf;
