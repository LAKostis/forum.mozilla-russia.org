...
function showSizeCtl(){
  if(document.getElementById) {
    ...
    document.writeln('<a href="javascript:sizeCtl(100)"><img src="'+baseURL+'wiki/images/larger.png" width="20" height="20" border="0"></a>');
    document.writeln('<a href="javascript:sizeCtl(-100)"><img src="'+baseURL+'wiki/images/smaller.png" width="20" height="20" border="0"></a>');
  }
}
